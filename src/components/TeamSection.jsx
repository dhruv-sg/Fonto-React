...
const TeamCard = ({ member, isActive, onMouseEnter, onMouseLeave }) => {
  ...
  return (
    <div
      className="relative group rounded-[1.5rem] overflow-hidden h-[450px] md:h-[500px] lg:h-[550px] bg-gray-100"
    >
      {/* Background Image */}
      <img
        src={member.image}
      ...
      >
        ...
        <div className="flex items-start justify-between mb-1">
          ...
          <div className="flex items-center gap-2 pt-1">
            <a href={member.linkedin} className="text-black hover:opacity-60 transition-opacity">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.238 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
              </svg>
            </a>
            <a href={member.twitter} className="text-black hover:opacity-60 transition-opacity">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
          <div ref={bioRef} className="text-gray-600 text-[13px] md:text-sm leading-snug">
            {member.bio}
          </div>
        </div>
      </div>
...
function TeamSection() {
  ...
  const team = [
    {
      ...
      name: 'Matthew Miller',
      role: 'Lead Designer',
      image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&h=1000&fit=crop', // Asian female portrait matches image
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=800&h=1000&fit=crop', // Older male portrait matches image
    ...
    },
    {
      ...
      role: 'Web Designer',
      image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=800&h=1000&fit=crop', // Male portrait matches image
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=1000&fit=crop', // Male portrait matches image
  ...
  return (
    <section ref={sectionRef} className="w-full bg-white py-12 md:py-16 lg:py-24 overflow-hidden">
      <div className={`px-[30px] transition-all duration-1000 ease-out ${
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12 md:mb-16">
          <div>
            <p className="text-sm md:text-base text-gray-400 mb-6 tracking-wide">• About Us</p>
          ...
          <span className="text-gray-400 font-medium text-lg self-end md:self-start">(08)</span>
        </div>
